...
public class ExcusesManager extends StorageUnit<Excuse> {
    ...
    public ExcusesManager addDefaultValues() {
        ...
        this.add(new Excuse("Die Bahn kam zu spät", ScenarioType.LATE_ARRIVAL).addTag(Tags.TRAIN)
                .addTag(Tags.MALE)
                .addTag(Tags.FEMALE))
                .add(new Excuse(
                        "Ich habe von einem Fußballspiel geträumt und als ich aufstehen musste, gab es eine Verlängerung.",
                        ScenarioType.LATE_ARRIVAL).addTag(Tags.FUNNY)
                                .addTag(Tags.MALE)
                                .addTag(Tags.FEMALE))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tags.FUNNY)
                                .addTag(Tags.AGGRESSIVE)
                                .addTag(Tags.MALE)
                                .addTag(Tags.FEMALE))
                .add(new Excuse("Sorry, aber mein Bus hat sich verfahren", ScenarioType.LATE_ARRIVAL).addTag(Tags.BUS)
                        .addTag(Tags.MALE)
                        .addTag(Tags.FEMALE))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tags.BUS)
                                .addTag(Tags.MALE)
                                .addTag(Tags.FEMALE))
                ...
                .add(new Excuse("Jaja, der erste Schnee! Da hatte natürlich gleich wieder die U-Bahn Verspätung.",
                        ScenarioType.LATE_ARRIVAL).addTag(Tags.SNOW)
                                .addTag(Tags.MALE)
                                .addTag(Tags.FEMALE))
                .add(new Excuse(
                        ...
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tags.FUNNY)
                                .addTag(Tags.MALE)
                                .addTag(Tags.FEMALE))
                .add(new Excuse(
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tags.MALE)
                                .addTag(Tags.FEMALE));
