...
public class ExcusesManager extends DataManager<Excuse> {
    ...
    private ObservableList<String> getTextSorted(Comparator<Excuse> sorting) {
        return FXCollections.observableArrayList(
                this.get().stream().sorted(sorting).map(Excuse::getText).collect(Collectors.toList()));
    }
        ...
        this.add(new Excuse("Die $tramLineLabel$ kam zu sp\u00e4t", ScenarioType.LATE_ARRIVAL).addTag(Tag.TRAIN_DELAYED)
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.FUNNY).addTag(Tag.MALE).addTag(Tag.FEMALE)
                                .addTag(Tag.FOOTBALL).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.FUNNY).addTag(Tag.AGGRESSIVE).addTag(Tag.MALE)
                                ...
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30))
                .add(new Excuse("Sorry, aber mein Bus hat sich verfahren", ScenarioType.LATE_ARRIVAL).addTag(Tag.BUS)
                        ...
                        .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30)
                        .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.AGE_OVER_50).addTag(Tag.FUNNY))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.BUS).addTag(Tag.MALE).addTag(Tag.FEMALE)
                                .addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.SNOW).addTag(Tag.TRAIN_DELAYED).addTag(Tag.MALE)
                                .addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_30_AND_50)
                ...
                .add(new Excuse("$rainHourly$ und direkt ist die Bahn \u00fcberfordert. Mir fehlen die Worte.",
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.RAINY).addTag(Tag.TRAIN_DELAYED).addTag(Tag.MALE)
                                .addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_30_AND_50)
                                .addTag(Tag.AGE_OVER_50))
                .add(new Excuse(
                        "$windSpeed$. Trump nimm das. Von wegen es w\u00fcrde die Klimaerw\u00e4rmung nicht geben.",
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.STORM).addTag(Tag.TRAIN_DELAYED).addTag(Tag.MALE)
                                .addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_30_AND_50)
                                .addTag(Tag.AGE_OVER_50).addTag(Tag.FUNNY))
                .add(new Excuse(
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.SUCK_UP)
                                .addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_30_AND_50)
                                .addTag(Tag.AGE_OVER_50).addTag(Tag.FUNNY))
                .add(new Excuse(
                        ...
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.SUCK_UP))
                .add(new Excuse(
                ...
                .add(new Excuse("Meine kleine Schwester hat gestern ausprobiert, wie ein Tintenkiller funktioniert.",
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.FUNNY))
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_30_AND_50)
                                .addTag(Tag.AGE_OVER_50).addTag(Tag.FUNNY))
                .add(new Excuse(
                ...
                .add(new Excuse("Entschuldigen Sie bitte, aber mein Hund hat meine Unterlagen gefressen.",
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.DOG)
                                .addTag(Tag.FUNNY).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.FUNNY))
                .add(new Excuse(
                ...
                .add(new Excuse("Ich dachte die Uhr w\u00e4re umgestellt worden.", ScenarioType.LATE_ARRIVAL)
                        .addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.FUNNY))
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.FUNNY).addTag(Tag.SUCK_UP).addTag(Tag.SETLX))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.AGE_OVER_50).addTag(Tag.TRAIN_DELAYED))
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.FUNNY).addTag(Tag.TRAIN_DELAYED))
                .add(new Excuse(
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.FUNNY).addTag(Tag.SUCK_UP))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.TRAIN_DELAYED).addTag(Tag.AGE_UNDER_18).addTag(Tag.FUNNY))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.SUCK_UP))
                .add(new Excuse(
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.WHEELOFFORTUNE).addTag(Tag.MALE).addTag(Tag.FEMALE)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_18_AND_21)
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGGRESSIVE))
                .add(new Excuse("Ich bin zu sp\u00e4t, weil mein Freund die M\u00e4nnergrippe hat.",
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.FEMALE).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.FUNNY))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.FEMALE).addTag(Tag.AGE_OVER_50)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGGRESSIVE))
                ...
                .add(new Excuse("Ich sage nur $newsEntryTitle$.", ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE)
                        .addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                        .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.AGE_OVER_50))
                .add(new Excuse(
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.AGE_OVER_50).addTag(Tag.AGGRESSIVE))
                .add(new Excuse("Haben Sie \u00fcberhaupt Beweise, dass ich zu sp\u00e4t bin?",
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGGRESSIVE))
                .add(new Excuse(
                        ...
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tag.MALE).addTag(Tag.FEMALE)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.AGGRESSIVE))
                .add(new Excuse(
                        "Entschuldigen Sie bitte meine Versp\u00e4tung, aber die Stra\u00dfenbahn hatte eine Versp\u00e4tung.",
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.TRAIN_DELAYED)
                                .addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_30_AND_50)
                                .addTag(Tag.AGE_OVER_50))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.AGE_OVER_50))
                .add(new Excuse(
                        "Entschuldigen Sie bitte meine Versp\u00e4tung, aber es gab einen $trafficIncidentTyp$ in $incidentLocationStreet$ ,$incidentLocationCity$.",
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30)
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.FUNNY))
                .add(new Excuse(
                        "Warum ich zu sp\u00e4t bin? Das ist doch vollkommen egal, aber lassen Sie uns \u00fcber Ihre neue sch\u00f6ne Frisur unterhalten.",
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.SUCK_UP))
                .add(new Excuse("Haben Sie ein neues Parf\u00fcm? Das wirkt augenscheinlich besonders gut auf Frauen.",
                        ScenarioType.WHEELOFFORTUNE).addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.SUCK_UP))
                ...
                .add(new Excuse("Ich bin nicht zu sp\u00e4t! Sie sind zu fr\u00fch!", ScenarioType.LATE_ARRIVAL)
                        .addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                        .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGGRESSIVE))
                .add(new Excuse(
                        ...
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.FUNNY)
                                .addTag(Tag.SUCK_UP))
                ...
                .add(new Excuse("Sorry, aber mein Bus hat sich verfahren.", ScenarioType.DELAYED_SUBMISSION)
                        .addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                        .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.FUNNY).addTag(Tag.BUS))
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.AGGRESSIVE)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.FUNNY))
                .add(new Excuse("Entschuldigen Sie, aber mein Fahrrad wurde gestohlen.",
                        ScenarioType.DELAYED_SUBMISSION).addTag(Tag.MALE).addTag(Tag.FEMALE).addTag(Tag.BICICLE)
                                .addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.FUNNY))
                .add(new Excuse(
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.MALE).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.FUNNY))
                .add(new Excuse(
                        "Mir war heute fr\u00fch schon wieder so merkw\u00fcrdig \u00fcbel. Da musste ich erst mal einen Schwangerschaftstest machen.",
                        ScenarioType.LATE_ARRIVAL).addTag(Tag.FEMALE).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_21_AND_30))
                .add(new Excuse(
                ...
                .add(new Excuse(
                        ...
                        ScenarioType.WHEELOFFORTUNE).addTag(Tag.FEMALE).addTag(Tag.AGE_BETWEEN_18_AND_21)
                                .addTag(Tag.AGE_UNDER_18).addTag(Tag.AGE_BETWEEN_21_AND_30)
                                .addTag(Tag.AGE_BETWEEN_30_AND_50).addTag(Tag.AGE_OVER_50).addTag(Tag.AGGRESSIVE))
                .add(new Excuse(
                        ...
                        ScenarioType.WHEELOFFORTUNE).addTag(Tag.MALE).addTag(Tag.FEMALE)
                                .addTag(Tag.AGE_BETWEEN_18_AND_21).addTag(Tag.AGE_UNDER_18)
                                .addTag(Tag.AGE_BETWEEN_21_AND_30).addTag(Tag.AGE_BETWEEN_30_AND_50)
                                .addTag(Tag.AGE_OVER_50).addTag(Tag.SUCK_UP))
